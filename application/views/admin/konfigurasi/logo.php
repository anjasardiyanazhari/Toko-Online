...
<label class="col-sm-2 control-label">Upload Logo Baru</label>

<div class="col-md-7">
<input type="file" name="logo" class="form-control"  placeholder="Upload Logo Baru" value="<?php echo $konfigurasi->logo ?>" required>
Logo Lama :<br> <img src="<?php echo base_url('assets/upload/img/'.$konfigurasi->logo) ?>" class="img img-responsive img-thumbnail" width="200">
</div>
</div>
