<p>
	<a href="<?php echo base_url('admin/produk/tambah') ?>" class="btn btn-success btn-lg"> <i class="fa fa-plus"></i> Tambah Baru</a>
 ...
 <table class="table table-bordered" id="example1">
 	...
 	<tbody>
 		...
 		<tr>
 			<td><?php echo $no ?></td>
 			<td>
 				<img src="<?php echo base_url('assets/upload/img/'.$produk->gambar) ?>" class="img img-responsive img-thumbnail" width="60">
 			</td>
