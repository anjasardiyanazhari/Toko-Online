...
//looping data kenanjang belanja
...
<td class="column-1">
	<div class="cart-img-product b-rad-4 o-f-hidden">
		<img src="<?php echo base_url('assets/upload/img/thumbs/'.$produk->gambar) ?>" alt="<?php echo $keranjang['name'] ?>">
	</div>
</td>
...
<tr class="table-row bg-info text-strong" style="font-weight: bold;">
	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				<td></td>	
				<td><button class="btn btn-success btn-lg" type="submit"><i class="fa fa-save"></i> Checkout Sekarang</button>
				<button class="btn btn-danger btn-lg" type="reset"><i class="fa fa-times"></i> Reset</button></td>
