<!--  -->
		...
		<li class="p-t-4">
		<a href="<?php echo base_url('dashbor') ?>" class="s-text13 active1">
		...
		<li class="p-t-4">
		<a href="<?php echo base_url('dashbor/belanja') ?>" class="s-text13 active1">
		<i class="fa fa-check"> Riwayat Belanja</i>
		</a>
		</li>

		<li class="p-t-4">
		<a href="<?php echo base_url('dashbor/profil') ?>" class="s-text13 active1">
