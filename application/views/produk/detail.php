...
<div class="slick3">
<div class="item-slick3" data-thumb="<?php echo base_url('assets/upload/img/thumbs/'.$produk->gambar) ?>">
<div class="wrap-pic-w">
	<img src="<?php echo base_url('assets/upload/img/'.$produk->gambar) ?>" alt="<?php echo $produk->nama_produk ?>">
</div>
</div>
...
<?php if ($gambar) {
 ...
 ?>
<div class="item-slick3" data-thumb="<?php echo base_url('assets/upload/img/thumbs/'.$gambar->gambar) ?>">
<div class="wrap-pic-w">
	<img src="<?php echo base_url('assets/upload/img/'.$gambar->gambar) ?>" alt="<?php echo $gambar->judul_gambar ?>">
</div>
</div>
<?php 
	}
...
<div class="block2-img wrap-pic-w of-hidden pos-relative block2-labelnew">
	<img src="<?php echo base_url('assets/upload/img/'.$produk_related->gambar) ?>" alt="<?php echo $produk_related->nama_produk ?>">
