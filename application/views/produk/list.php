		<!-- Title Page -->
		<section class="bg-title-page p-t-50 p-b-40 flex-col-c-m" style="background-image: url(<?php echo base_url() ?>assets/template/images/baner1.jpg);">
		...
		<ul class="p-b-54">
			<?php 
			foreach ($listing_kategori as $listing_kategori) {
	...
	?>
		...
		<img src="<?php echo base_url('assets/upload/img/thumbs/'.$produk->gambar) ?>" alt="<?php echo $produk->nama_produk ?>">
