...
<div class="col-md-12">
	...
	<table class="table">
		...
		<tbody>
			...
			<tr>
				<td>Telepon</td>
				<td><input type="text" name="telepon" class="form-control" placeholder="Telepon" value="<?php echo set_value('telepon') ?>"></td>
			</tr>
			<tr>
				<td>Alamat</td>
			...
			<tr>
				<td></td>	
				<td><button class="btn btn-success btn-lg" name="submit" type="submit"><i class="fa fa-save"></i> Submit</button>
